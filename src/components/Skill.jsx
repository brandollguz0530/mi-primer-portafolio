...
const Skill = () => {
  return (
    <div className=' bg-[#1A1A1AE5] bg-opacity-70  rounded-xl mx-10 flex flex-col justify-center items-center'>

        <h3 className=' text-white font-semibold mt-4'>
        technologies that I use
        </h3>
    <div className=' w-[250px] h-[250px] bg-[#3E3C3C80] rounded-lg mt-5 flex flex-col items-center justify-center'>
